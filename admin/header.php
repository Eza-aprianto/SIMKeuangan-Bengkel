...
<head>
  ...
  <title>Administrator - SIMK-Bengkel</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>SIMK | Bengkel</b></span>
      </a>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <!-- <li>
            <a href="barang.php">
            <i class="fa fa-truck" aria-hidden="true"></i> <span>DATA BARANG</span>
            </a>
          </li> -->
          
          <li>
            <a href="stok.php">
              <i class="fa fa-archive" aria-hidden="true"></i> <span>DATA STOK</span>
            </a>
          </li>
          ...
          <li>
            ...
            <i class="fa fa-money" aria-hidden="true"></i> <span>DATA TRANSAKSI</span>
            </a>
          </li>          
